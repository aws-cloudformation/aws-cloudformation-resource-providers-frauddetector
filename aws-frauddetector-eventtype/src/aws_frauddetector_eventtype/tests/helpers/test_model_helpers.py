from aws_frauddetector_eventtype.helpers import model_helpers
from unittest.mock import MagicMock
from .. import unit_test_utils


def test_get_event_type_and_return_model():
    # Arrange
    ...
    # Act
    model_for_outcome = model_helpers.get_event_type_and_return_model(mock_afd_client,
                                                                      unit_test_utils.create_fake_model())
...
def test_get_inline_resources():
    # Arrange - fake model has all inline dependencies
    fake_model = unit_test_utils.create_fake_model()

    # Act
    inline_resources: dict = model_helpers.get_inline_resources(fake_model)
