...
1. Write the JSON schema describing your resource, `aws-frauddetector-variable.json`
2. Implement your resource handlers in `aws_frauddetector_variable/handlers.py`
