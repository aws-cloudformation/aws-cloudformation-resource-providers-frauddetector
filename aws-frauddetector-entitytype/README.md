...
1. Write the JSON schema describing your resource, `aws-frauddetector-entitytype.json`
2. Implement your resource handlers in `aws_frauddetector_entitytype/handlers.py`
