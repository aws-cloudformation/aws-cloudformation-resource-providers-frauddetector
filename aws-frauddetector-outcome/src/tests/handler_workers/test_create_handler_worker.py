...
def test_execute_create_outcome_handler_work_model_has_arn_gets_invalid_request_error(
    monkeypatch,
):
    # Arrange
    model, progress = _setup_execute_create_outcome_handler_work_test(monkeypatch)
...
def test_execute_create_outcome_handler_work_model_has_created_time_gets_invalid_request_error(
    monkeypatch,
):
    # Arrange
    model, progress = _setup_execute_create_outcome_handler_work_test(monkeypatch)
...
def test_execute_create_outcome_handler_work_model_has_updated_time_gets_invalid_request_error(
    monkeypatch,
):
    # Arrange
    model, progress = _setup_execute_create_outcome_handler_work_test(monkeypatch)
...
def test_execute_create_outcome_handler_work_with_existing_outcome_gets_already_exists_error(
    monkeypatch,
):
    # Arrange
    model, progress = _setup_execute_create_outcome_handler_work_test(monkeypatch)
...
def test_execute_create_outcome_handler_work_with_none_tags_removes_tags_attr(
    monkeypatch,
):
    # Arrange
    model, progress = _setup_execute_create_outcome_handler_work_test(monkeypatch)
...
def _setup_execute_create_outcome_handler_work_test(monkeypatch):
    ...
    monkeypatch.setattr(
        common_helpers,
        "put_outcome_and_return_progress",
        mock_put_outcome_and_return_progress,
    )
