...
def test_execute_update_outcome_handler_work_with_non_existing_outcome_gets_not_found_error(
    monkeypatch,
):
    # Arrange
    model, progress, request = _setup_execute_update_outcome_handler_work_test(monkeypatch)
...
def test_execute_update_outcome_handler_work_model_has_different_name_gets_not_updatable_error(
    monkeypatch,
):
    # Arrange
    model, progress, request = _setup_execute_update_outcome_handler_work_test(monkeypatch)
...
def test_execute_update_outcome_handler_work_with_none_tags_removes_tags_attr(
    monkeypatch,
):
    # Arrange
    model, progress, request = _setup_execute_update_outcome_handler_work_test(monkeypatch)
