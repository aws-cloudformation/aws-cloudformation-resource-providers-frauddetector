...
1. Write the JSON schema describing your resource, `aws-frauddetector-label.json`
2. Implement your resource handlers in `aws_frauddetector_label/handlers.py`
